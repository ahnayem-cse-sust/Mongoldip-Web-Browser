...
namespace SharpBrowser {
	...
	internal partial class MainForm : Form {
		...
		public static string Branding = "MongolSharpBrowser";
		...
		public MainForm() {
            ...
            Speak("MongolDip web browser is loading.");
        ...
        private void tabStripKeyPreview(object sender, PreviewKeyDownEventArgs e)
        {
            if (e.KeyCode == Keys.Escape)
            {
                MessageBox.Show("This is Tabstrip");
                
            }
        }

        private void Main_Form_KeyPressed(object sender, KeyPressEventArgs e)
        {
            stopSpeak();
            char c = e.KeyChar;
            string s = ""+c;
        ...
        private void MouseEnterTxtURL(object sender, EventArgs e)
        {
            try
            {
                sSynth.Dispose();
            ...
            Speak("You are on url box Click to enter a new url");
        }
